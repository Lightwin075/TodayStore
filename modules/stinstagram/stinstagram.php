...
class StInstagram extends Module implements WidgetInterface
{
    ...
    {
        $this->_tabs = array(
            array('id'  => '10,0', 'name' => $this->getTranslator()->trans('General settings', array(), 'Admin.Theme.Panda')),
                ...
                array(
                    ...
                    'values' => array(
                        ...
                        /*array(
                            'id' => 'show_profile_2',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Yes, center layout', array(), 'Admin.Theme.Panda')),*/
                        array(
                            'id' => 'show_profile_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('No', array(), 'Admin.Theme.Panda')),
        ...
        if (isset($_FILES[$item]) && isset($_FILES[$item]['tmp_name']) && !empty($_FILES[$item]['tmp_name'])) {
            ...
            if (!empty($imagesize) &&
                ...
                if ($upload_error = ImageManager::validateUpload($_FILES[$item])) {
                    ...
                    $result['error'][] = $this->getTranslator()->trans('An error occurred during move image.', array(), 'Modules.StInstagram.Admin');
                } else {
