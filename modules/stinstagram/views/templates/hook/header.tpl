...
//<![CDATA[
var ins_follow = "{l s='Follow' d='Shop.Theme.Panda'}";
var ins_posts = "{l s='Posts' d='Shop.Theme.Panda'}";
var ins_followers = "{l s='Followers' d='Shop.Theme.Panda'}";
var ins_following = "{l s='Following' d='Shop.Theme.Panda'}";
var stinstagram_view_in_ins = "{l s='View in Instagram' d='Shop.Theme.Panda'}";
var stinstagram_view_larger = "{l s='Click to view larger' d='Shop.Theme.Panda'}";
var st_timeago_suffixAgo= "{l s='ago' d='Shop.Theme.Panda'}";
var st_timeago_suffixFromNow= "{l s='from now' d='Shop.Theme.Panda'}";
var st_timeago_inPast= "{l s='any moment now' d='Shop.Theme.Panda'}";
var st_timeago_seconds= "{l s='less than a minute' d='Shop.Theme.Panda'}";
var st_timeago_minute= "{l s='about a minute' d='Shop.Theme.Panda'}";
var st_timeago_minutes= "#d {l s='minutes' d='Shop.Theme.Panda'}";
var st_timeago_hour= "{l s='about an hour' d='Shop.Theme.Panda'}";
var st_timeago_hours= "{l s='about #d hours' d='Shop.Theme.Panda'}";
var st_timeago_day= "{l s='a day' d='Shop.Theme.Panda'}";
var st_timeago_days= "#d {l s='days' d='Shop.Theme.Panda'}";
var st_timeago_month= "{l s='about a month' d='Shop.Theme.Panda'}";
var st_timeago_months= "#d {l s='months' d='Shop.Theme.Panda'}";
var st_timeago_year= "{l s='about a year' d='Shop.Theme.Panda'}";
var st_timeago_years= "#d {l s='years' d='Shop.Theme.Panda'}";
var st_timeago_years= "#d {l s='years' d='Shop.Theme.Panda'}";
var ins_previous= "{l s='Previous' d='Shop.Theme.Panda'}";
var ins_next= "{l s='Next' d='Shop.Theme.Panda'}";
{literal}
