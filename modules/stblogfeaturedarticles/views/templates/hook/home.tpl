            ...
            <div class="products_slider {if $p_c.grid==1} display_as_grid {elseif $p_c.grid==2} display_as_simple {/if}">
                ...
                <div class="title_block flex_container title_align_{if $column_slider}0{else}{(int)$p_c.title_align}{/if} title_style_{if isset($is_blog) && $is_blog}{(int)$stblog.heading_style}{else}{(int)$sttheme.heading_style}{/if}">
                    ...
                    {if $p_c.link}<a href="{$p_c.link}" title="{$p_c.name}" class="title_block_inner">{else}<div class="title_block_inner">{/if}
                        ...
                        {else}
                            {if isset($p_c.is_root_category) && $p_c.is_root_category}{l s='Featured articles' d='Shop.Theme.Panda'}{else}{$p_c.name}{/if}
                        {/if}
                ...
                {if isset($p_c.blogs) && $p_c.blogs}
                    ...
                    {/if}
                    {if isset($p_c.view_more) && $p_c.view_more && $p_c.link}<div class="product_view_more_box text-center p-t-1"><a href="{$p_c.link}" class="btn btn-default btn-more-padding btn-large" title="{l s='View more' d='Shop.Theme.Panda'}">{l s='View more' d='Shop.Theme.Panda'}</a></div>{/if}
                {else}
                    <p class="warning">{l s='No posts' d='Shop.Theme.Panda'}</p>
                {/if}
            </div>
        </section>
