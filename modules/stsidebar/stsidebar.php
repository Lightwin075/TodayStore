...
class StSidebar extends Module implements WidgetInterface
{
    ...
    private function initDirection()
    {
        $this->_direciton = array(
                        array(
                            'id' => 'direction_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Default', array(), 'Admin.Theme.Panda')
                        ),
                        array(
                            'id' => 'direction_1',
                            'value' => 1,
                            'label' => $this->getTranslatOr()->trans('Right side', array(), 'Admin.Theme.Panda')
                        ),
                        array(
                            'id' => 'direction_2',
                            'value' => 2,
                            'label' => $this->getTranslatOr()->trans('Left side', array(), 'Admin.Theme.Panda')
                        ),
                    );
    }
    private function initLocation()
    {
        $this->_location = array(
                        ...
                        2=>array(
                            'id' => 'location_2',
                            'value' => 2,
                            'label' => $this->getTranslatOr()->trans('Mobile bar right', array(), 'Admin.Theme.Panda'),
                            'direction' => 1,
                        ),
                        3=>array(
                            'id' => 'location_3',
                            'value' => 3,
                            'label' => $this->getTranslatOr()->trans('Mobile bar center', array(), 'Admin.Theme.Panda'),
                            'direction' => 1,
                        ),
                        4=>array(
                            'id' => 'location_4',
                            'value' => 4,
                            'label' => $this->getTranslatOr()->trans('Mobile bar left', array(), 'Admin.Theme.Panda'),
                            'direction' => 2,
                        ),
                        5=>array(
                            'id' => 'location_5',
                            'value' => 5,
                            'label' => $this->getTranslatOr()->trans('Mobile bar bottom - items have even width', array(), 'Admin.Theme.Panda'),
                            'direction' => 1,
                        ),
                    );
    }
    private function initSidebarPosition()
    {
        $this->_sidebar_position = array(
            array('id' => '1_0', 'name' => $this->getTranslator()->trans('At bottom of screen', array(), 'Admin.Theme.Panda')),
            array('id' => '1_10', 'name' => $this->getTranslator()->trans('Bottom', array(), 'Admin.Theme.Panda').' 10%'),
            array('id' => '1_20', 'name' => $this->getTranslator()->trans('Bottom', array(), 'Admin.Theme.Panda').' 20%'),
            array('id' => '1_30', 'name' => $this->getTranslator()->trans('Bottom', array(), 'Admin.Theme.Panda').' 30%'),
            array('id' => '1_40', 'name' => $this->getTranslator()->trans('Bottom', array(), 'Admin.Theme.Panda').' 40%'),
            array('id' => '1_50', 'name' => $this->getTranslator()->trans('Bottom', array(), 'Admin.Theme.Panda').' 50%'),
            array('id' => '2_0', 'name' => $this->getTranslator()->trans('At top of screen', array(), 'Admin.Theme.Panda')),
            array('id' => '2_10', 'name' => $this->getTranslator()->trans('Top', array(), 'Admin.Theme.Panda').' 10%'),
            array('id' => '2_20', 'name' => $this->getTranslator()->trans('Top', array(), 'Admin.Theme.Panda').' 20%'),
            array('id' => '2_30', 'name' => $this->getTranslator()->trans('Top', array(), 'Admin.Theme.Panda').' 30%'),
            array('id' => '2_40', 'name' => $this->getTranslator()->trans('Top', array(), 'Admin.Theme.Panda').' 40%'),
            array('id' => '2_50', 'name' => $this->getTranslator()->trans('Top', array(), 'Admin.Theme.Panda').' 50%'),
        );
    }
            ...
            if (!count($error) && $sidebar->validateFields(false) && $sidebar->validateFieldsLang(false))
            {
                ...
                if($sidebar->save())
                {
                    ...
                    if(isset($_POST['savestsidebarAndStay']) || Tools::getValue('fr') == 'view')
                    {
                        ...
                        $this->_html .= $this->displayConfirmation($this->getTranslator()->trans('Sidebar', array(), 'Modules.StSidebar.Admin').' '.($id_st_sidebar ? $this->gettranslator()->trans('updated', array(), 'Admin.Theme.Panda') : $this->gettranslator()->trans('added', array(), 'Admin.Theme.Panda')));
                }                    
                else
                    $this->_html .= $this->displayError($this->getTranslator()->trans('an error occurred during sidebar', array(), 'Modules.StSidebar.Admin').' '.($id_st_sidebar ? $this->gettranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->gettranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
            }
            else
    ...
    protected function initList()
    {
        $this->fields_list = array(
            ...
            'location' => array(
                'title' => $this->getTranslator()->trans('Location', array(), 'Admin.Theme.Panda'),
                'width' => 200,
                'type' => 'text',
            ...
            'direction' => array(
                'title' => $this->getTranslator()->trans('Open from', array(), 'Admin.Theme.Panda'),
                'width' => 200,
                'type' => 'text',
    ...
    {        
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Open the sidebar from left or right side:', array(), 'Admin.Theme.Panda'),
                    'name' => 'direction',
                    'default_value' => 0,
        ...
        $this->fields_form[1]['form'] = array(
            ...
            'input' => array( 
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Icon background color:', array(), 'Admin.Theme.Panda'),
                    'name' => 'btn_bg',
                    'size' => 33,
                ),
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Icon hover color:', array(), 'Admin.Theme.Panda'),
                    'name' => 'btn_hover_color',
                    'size' => 33,
                ),
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Icon hover background color:', array(), 'Admin.Theme.Panda'),
                    'name' => 'btn_hover_bg',
                    'size' => 33,
                ),
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'desc' => $this->getTranslator()->trans('Set it to 0 to use the default width', array(), 'Admin.Theme.Panda'),
                ),
            ),
			'submit' => array(
    ...
    {        
        ...
        {   
            ...
            if($percent_of_screen = Configuration::get($this->_prefix_st.'POSITION_RIGHT'))
            {
                ...
                $custom_css .='#rightbar{top:'.($percent_of_screen_arr[0]==2 ? $percent_of_screen_arr[1].'%' : 'auto').'; bottom: 10%;}';
            }
    ...
    {
        if (!$this->isCached($this->templateFile[3], $this->getCacheId())) {
        ...
        return $this->fetch($this->templateFile[3], $this->getCacheId());
    }
