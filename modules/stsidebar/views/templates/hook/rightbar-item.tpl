...
{if $sidebar_item.native_modules==1}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_cart rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="javascript:;" data-name="side_products_cart" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" class="rightbar_tri icon_wrap with_text" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='View my shopping cart' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==2}
	<section id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_compare rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a class="rightbar_tri icon_wrap with_text" data-name="side_products_compared" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" href="{$link->getPageLink('products-comparison')|escape:'html'}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Compare Products' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==3}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_viewed rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="javascript:;" class="rightbar_tri icon_wrap with_text" data-name="side_viewed" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Recently Viewed' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==4}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_qrcode rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="javascript:;" class="rightbar_tri icon_wrap with_text" data-name="side_qrcode" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='QR code' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==5}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="to_top_wrap rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="#top_bar" class="to_top_btn icon_wrap with_text" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Back to top' d='Shop.Theme.Panda'}{/if}"><i class="{if $sidebar_item.icon_class}{$sidebar_item.icon_class}{else}fto-up-open-2{/if}"></i><span class="icon_text">{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Top' d='Shop.Theme.Panda'}{/if}</span></a>
	</div>
{elseif $sidebar_item.native_modules==6}
	<div  id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_menu rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
		<a class="rightbar_tri icon_wrap with_text" data-name="side_stmobilemenu" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" href="javascript:;" rel="nofollow" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Menu' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==7}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_nav rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="javascript:;" class="rightbar_tri icon_wrap with_text" data-name="side_mobile_nav" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Settings' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==8}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_search rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="javascript:;" class="rightbar_tri icon_wrap with_text" data-name="side_search" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Search' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==9}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_share rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="javascript:;" class="rightbar_tri icon_wrap with_text" data-name="side_share" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Share' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==10}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_viewed rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="javascript:;" class="rightbar_tri icon_wrap with_text" data-name="side_loved" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Loved products' d='Shop.Theme.Panda'}{/if}">
