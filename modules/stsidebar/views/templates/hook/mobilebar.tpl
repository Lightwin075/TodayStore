...
{if $sidebar_item.native_modules==1}
	<a id="rightbar_{$sidebar_item.id_st_sidebar}" href="javascript:;" rel="nofollow" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='View my shopping cart' d='Shop.Theme.Panda'}{/if}" class="cart_mobile_bar_tri mobile_bar_tri mobile_bar_item shopping_cart_style_{$block_cart_style}" data-name="side_products_cart" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}">
...
{elseif $sidebar_item.native_modules==4}
	<a id="rightbar_{$sidebar_item.id_st_sidebar}" class="qrcode_mobile_bar_tri mobile_bar_item mobile_bar_tri" data-name="side_qrcode" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" href="javascript:;" rel="nofollow" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='QR code' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==5}
	<a id="rightbar_{$sidebar_item.id_st_sidebar}" class="to_top_mobile_bar_tri mobile_bar_item"  href="#top_bar" rel="nofollow" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Top' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==6}
	<a id="rightbar_{$sidebar_item.id_st_sidebar}" class="menu_mobile_bar_tri mobile_bar_item mobile_bar_tri {if $sttheme.menu_icon_with_text==1} with_text{/if}" data-name="side_stmobilemenu" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" href="javascript:;" rel="nofollow" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Menu' d='Shop.Theme.Panda'}{/if}">
...
{elseif $sidebar_item.native_modules==7}
	<a id="rightbar_{$sidebar_item.id_st_sidebar}" class="customer_mobile_bar_tri mobile_bar_item mobile_bar_tri" data-name="side_mobile_nav" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" href="javascript:;" rel="nofollow" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Settings' d='Shop.Theme.Panda'}{/if}">
