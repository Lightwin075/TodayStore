...
{block name="page_content"}
	{if $id_customer|intval neq 0}
        {if !$id_st_wishlist}
    <h3 class="page_heading">{l s='My wishlists' d='Shop.Theme.Panda'}</h3>
        ...
        {foreach $wishlists AS $wishlist}
            <li class="wishlist_item">
                ...
                <div class="wishlist_title_box flex_container">
                    ...
                    <a href="{$link->getModuleLink('stwishlist', 'mywishlist', ['delete'=>true,'id_st_wishlist'=>$wishlist['id_st_wishlist']], true)}" title="{l s='Delete wishlist' d='Shop.Theme.Panda'}"><i class="fto-cancel"></i></a>{*use url function*}
                </div>
            </li>
        {/foreach}
        </ul>
        ...
        <div class="form-group form-group-small ">
            <label>{l s='Share to firends' d='Shop.Theme.Panda'}</label>
            <div class="input-group">
        ...
        {/foreach}
            <p><a class="btn btn-default" href="{$link->getModuleLink('stwishlist', 'mywishlist', array(), true)}" title="{l s='Back to wishlists' d='Shop.Theme.Panda'}">{l s='Back to wishlists' d='Shop.Theme.Panda'}</a></p>
        {/if}
      {/if}
	{/if}
{/block}