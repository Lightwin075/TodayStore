...
{if $sttheme.flyout_share && isset($stsocial) && $stsocial}
	<div class="hover_fly_btn social_share_button" href="javascript:;" rel="nofollow" title="{l s='Share on social networks' d='Shop.Theme.Panda'}">
		...
		<div class="hover_fly_btn_inner"><i class="fto-share-1"></i><span>{l s='Share' d='Shop.Theme.Panda'}</span></div>
	</div>
{/if}