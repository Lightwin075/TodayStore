...
class FormElement8 extends StEasyContent
{
    public function initFormElement()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Style text:', array(), 'Admin.Theme.Panda'),
                    ...
                    'values' => array(
                        ...
                        array(
                            ...
                            'value' => 'blockquote',
                            'label' => $this->getTranslator()->trans('Blockquote 1', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'st_el_text_style_blockquote_2',
                            'value' => 'blockquote_1',
                            'label' => $this->getTranslator()->trans('Blockquote 2, make sure the first html tag is p.', array(), 'Admin.Theme.Panda')),
                    ),
                    'default_value' => '',
                    'validation' => 'isGenericName',
                ),
        ...
        $this->fields_form[5]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Image settings:', array(), 'Admin.Theme.Panda'),
                'icon' => 'icon-cogs',                
            ),
            'input' => array(
                array(
                ...
                array(
                    ...
                    'desc' => array(
                            ...
                            $this->getTranslator()->trans('Leave it empty to use the default value.', array(), 'Admin.Theme.Panda'),
                            ),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Image width:', array(), 'Admin.Theme.Panda'),
                    'name' => 'st_image_width',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'default_value' => '',
        ...
        $this->fields_form[6]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Text settings:', array(), 'Admin.Theme.Panda'),
                'icon' => 'icon-cogs'                
            ),
            'input' => array(
                array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Header font size:', array(), 'Admin.Theme.Panda'),
                    'name' => 'st_header_size',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'default_value' => 0,
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Button hover background:', array(), 'Admin.Theme.Panda'),
    ...
    public function initFormElementSetting()
    {
        ...
        $this->fields_form[1]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Slider settings:', array(), 'Admin.Theme.Panda'),
                'icon' => 'icon-cogs',                
            ),
            'input' => array(
                array(
