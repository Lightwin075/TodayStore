    ...
    public function initFormElement()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Text size:', array(), 'Admin.Theme.Panda'),
                    'name' => 'st_text_size',
                    'prefix' => 'px',
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Border:', array(), 'Admin.Theme.Panda'),
                    'name' => 'st_border_style',
                    'values' => array(
                        array(
                            'id' => 'text_align_left',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Solid', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'text_align_center',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Dotted', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'text_align_right',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Dashed', array(), 'Admin.Theme.Panda')),
                    ),
                    'default_value' => 0,
                    'validation' => 'isUnsignedInt',
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Margin top:', array(), 'Admin.Theme.Panda'),
                    'name' => 'st_margin_top',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'default_value' => '',
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Margin bottom:', array(), 'Admin.Theme.Panda'),
                ...
                array(
                    ...
                    'default_value' => '',
                    'validation' => 'isNullOrUnsignedId',
                    'desc' => $this->getTranslator()->trans('If the value is 0 or empty, this divider will be full width.', array(), 'Admin.Theme.Panda'),
                ),
                array(
                    'type' => 'radio',
