    ...
    public function initFormElement()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Link url:', array(), 'Admin.Theme.Panda'),
                    'name' => 'st_el_url',
                    'lang' => true,
                    'validation' => 'isGenericName',
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('button text:', array(), 'Admin.Theme.Panda'),
                    'name' => 'st_el_button',
                    'lang' => true,
                    'validation' => 'isGenericName',
                ),
        ...
        $this->fields_form[6]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Header hover color:', array(), 'Admin.Theme.Panda'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Header bottom spacing:', array(), 'Admin.Theme.Panda'),
                ...
                array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Header fonts:', array(), 'Admin.Theme.Panda'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Text bottom spacing:', array(), 'Admin.Theme.Panda'),
        ...
        $this->fields_form[7]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Left and right padding:', array(), 'Admin.Theme.Panda'),
