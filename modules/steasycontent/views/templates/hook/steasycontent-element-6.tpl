...
{if !isset($element.st_slider_s_speed) || !$element.st_slider_s_speed}{$element.st_slider_s_speed=7000}{/if}
{if !isset($element.st_slider_a_speed) || !$element.st_slider_a_speed}{$element.st_slider_a_speed=400}{/if}
...
<section class="products_section">
    {if isset($element.products) && $element.products && count($element.products)}
        ...
        {if !$element.st_grid}
            ...
            slider_s_speed=$element.st_slider_s_speed
            slider_slideshow=$element.st_slideshow
            slider_a_speed=$element.st_slider_a_speed
