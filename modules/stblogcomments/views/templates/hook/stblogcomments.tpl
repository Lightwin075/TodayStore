...
<section id="comments" class="block section">
    <div class="title_block flex_container title_align_0 title_style_{(int)$stblog.heading_style}">
        ...
        <div class="title_block_inner">{$nbComments}&nbsp;{if $nbComments<=1}{l s='Comment' d='Shop.Theme.Panda'}{else}{l s='Comments' d='Shop.Theme.Panda'}{/if}</div>
...
<section id="st_blog_comment_reply_block" class="block section">
    <div class="title_block flex_container title_align_0 title_style_{(int)$stblog.heading_style}">
        <div class="flex_child title_flex_left"></div>
        <div id="stblog_leave_a_comment" class="title_block_inner">{l s='Leave a Comment' d='Shop.Theme.Panda'}</div>
        <div id="stblog_leave_a_reply" class="title_block_inner">{l s='Leave a Reply' d='Shop.Theme.Panda'}</div>
        <div class="flex_child title_flex_right"></div>
    </div>
	<div class="st_blog_comment_reply">
        ...
        <form name="st_blog_comment_form" action="{$link->getModuleLink('stblogcomments','default',['action'=>'add_comment','secure_key'=>$secure_key])}">
            ...
            <div id="comment_input" class="row">
                <p class="col-4"><input name="customer_name" type="text" class="form-control" placeholder="{l s='Name (required)' d='Shop.Theme.Panda'}" value="" /></p>
                <p class="col-4"><input name="customer_email" type="text" class="form-control" placeholder="{l s='Email' d='Shop.Theme.Panda'}" value="" /></p>
            </div>
            {/if}
            ...
            <div>
                <input type="submit" name="st_blog_comment_submit" id="st_blog_comment_submit" value="{l s='Post comment' d='Shop.Theme.Panda'}" class="btn btn-default mar_r4" />
        ...
        {l s='You should wait %delay% seconds before posting a new comment.' sprintf=['%delay%' => $delay] d='Shop.Theme.Panda'}
        {/if}
    </div>
</section>