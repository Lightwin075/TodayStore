...
class StProductLinkNav extends Module
{
    ...
    private function _prepareHook($nav)
    {
        ...
        if (!isset($this->context->link->cookie->nav_last_visited_category) || !Product::idIsOnCategoryId($id_product, array('0' => array('id_category' => $this->context->cookie->nav_last_visited_category))))
