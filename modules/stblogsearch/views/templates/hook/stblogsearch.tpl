...
<div id="stb_search_block_left" class="block column_block">
	<div class="title_block flex_container title_align_0 title_style_{(int)$stblog.heading_style}">
        ...
        <div class="title_block_inner">{l s='Blog search' d='Shop.Theme.Panda'}</div>
    ...
    <div class="block_content">
		<form method="get" action="{url entity='module' name='stblogsearch' controller='default'}" id="stb_searchbox">
			...
			<div class="input-group round_item js-parent-focus input-group-with-border">
		      <input type="text" class="form-control search_query js-child-focus" id="stb_search_query_block" name="stb_search_query" value="{$search_query}" placeholder="{l s='Search' d='Shop.Theme.Panda'}">
