...
class BaseSlider extends Module
{
	...
	function __construct()
	{
        if (!$this->name || !$this->displayName) {
            die($this->getTranslator()->trans('Module name and displayName are requried!', array(), 'Admin.Theme.Panda'));
        }
        if (!$this->_prefix_st || !$this->_prefix_stsn) {
            die($this->getTranslator()->trans('Field prefix is requried!', array(), 'Admin.Theme.Panda'));
        }
            ...
            foreach($values AS $value)
            {
                ...
                if (Tools::getValue($key.'_'.$value['id']))
                {
                    ...
                    if (!$this->isHookableOn($value['id'])) {
                        $id = $value['id'];
                        $this->validation_errors[] = $this->getTranslator()->trans('This module cannot be transplanted to %id%.', array('%id%'=>$id), 'Admin.Theme.Panda');
                    } 
                    else
    ...
    public function getFormFields()
    {
        ...
        $form_fields['home_slider'] = array(
            'grid' => array(
                'type' => 'radio',
                'label' => $this->getTranslator()->trans('How to display products:', array(), 'Admin.Theme.Panda'),
                'name' => 'grid',
                'default_value' => 0,
                'values' => array(
                    array(
                    ...
                    array(
                        'id' => 'grid_xiao',
                        'value' => 2,
                        'label' => $this->getTranslator()->trans('Simple layout', array(), 'Admin.Theme.Panda')),
                ),
                'validation' => 'isUnsignedInt',
            ), 
            'nbr' => array(
                'type' => 'text',
                'label' => $this->getTranslator()->trans('Define the number of products to be displayed:', array(), 'Admin.Theme.Panda'),
                'name' => 'nbr',
                'default_value' => 8,
                // 'required' => true,
                'validation' => 'isUnsignedInt',
            ...
            'spacing_between' => array(
                ...
                'class' => 'fixed-width-lg',
                'desc' => array(                            
                        $this->getTranslator()->trans('Distance between products.', array(), 'Admin.Theme.Panda'),                          
                    ),
            ),
            'image_type'=>array(
    			'type' => 'select',
    			'label' => $this->getTranslator()->trans('Image type for products in Grid view and Slider:', array(), 'Admin.Theme.Panda'),
    			'name' => 'image_type',
            ...
            'display_sd' => array(
                'type' => 'radio',
                'label' => $this->getTranslator()->trans('Display product short description:', array(), 'Admin.Theme.Panda'),
                'name' => 'display_sd',
                'default_value' => 0,
                'values' => array(
                    array(
                    ...
                    array(
                        'id' => 'display_sd_on',
                        'value' => 1,
                        'label' => $this->getTranslator()->trans('Yes, 220 characters', array(), 'Admin.Theme.Panda')),
                    array(
                        'id' => 'display_sd_full',
                        'value' => 2,
                        'label' => $this->getTranslator()->trans('Yes, full short description', array(), 'Admin.Theme.Panda')),
                ),
                'validation' => 'isUnsignedInt',
            ), 
            'top_padding' => array(
            ...
            'text_color' => array(
             ...
             'price_color' => array(
                'type' => 'color',
                'label' => $this->getTranslator()->trans('Price color:', array(), 'Admin.Theme.Panda'),
                'name' => 'price_color',
                'class' => 'color',
                'size' => 20,
                'validation' => 'isColor',
             ...
             'link_hover_color' => array(
                'type' => 'color',
                'label' => $this->getTranslator()->trans('Product name hover color:', array(), 'Admin.Theme.Panda'),
             ...
             'grid_bg' => array(
                'type' => 'color',
                'label' => $this->getTranslator()->trans('Grid background:', array(), 'Admin.Theme.Panda'),
                'name' => 'grid_bg',
                'class' => 'color',
                'size' => 20,
                'validation' => 'isColor',
             ...
             'grid_hover_bg' => array(
                'type' => 'color',
                'label' => $this->getTranslator()->trans('Grid hover background:', array(), 'Admin.Theme.Panda'),
                'name' => 'grid_hover_bg',
                'class' => 'color',
                'size' => 20,
                'validation' => 'isColor',
             ...
             'view_more' => array(
                'type' => 'switch',
                'label' => $this->getTranslator()->trans('Show "View more" button:', array(), 'Admin.Theme.Panda'),
                'name' => 'view_more',
                'default_value' => 0,
                'is_bool' => true,
                'values' => array(
        ...
        $form_fields['column'] = array(
            'display_pro_col' => array(
                ...
                'values' => array(
                    array(
                        ...
                        'value' => 0,
                        'label' => '<img src="'._MODULE_DIR_.'stthemeeditor/img/column_product_slider_0.jpg" />'.$this->getTranslator()->trans('Compact slider, several items per view', array(), 'Admin.Theme.Panda')),
                    array(
                        'id' => 'display_pro_col_1',
                        'value' => 1,
                        'label' => '<img src="'._MODULE_DIR_.'stthemeeditor/img/column_product_slider_1.jpg" />'.$this->getTranslator()->trans('Slider, only one item per view', array(), 'Admin.Theme.Panda')),
                    /*array(
            ...
            'items_col' => array(
				'type' => 'text',
				'label' => $this->getTranslator()->trans('How many products per view on compact slider:', array(), 'Admin.Theme.Panda'),
				'name' => 'items_col',
                'default_value' => 4,
                'validation' => 'isUnsignedInt',
                'class' => 'fixed-width-sm'
            ...
            'lazy_col' => array(
                ...
                'validation' => 'isBool',
                'desc' => $this->getTranslator()->trans('Delays loading of images. Images outside of viewport will not be loaded before user scrolls to them. Great for mobile devices to speed up page loadings.', array(), 'Admin.Theme.Panda'),
            ),
            'hide_mob_col' => array(
                'type' => 'radio',
                'label' => $this->getTranslator()->trans('Hide on small screen devices:', array(), 'Admin.Theme.Panda'),
