...
$fields_form[0]['form'] = array(
	'input' => array(
		array(
			...
			'name' => '<button type="button" id="import_export" class="btn btn-default"><i class="icon process-icon-new-module"></i> '.$this->getTranslator()->trans('Import/export', array(), 'Modules.StThemeeditor.Admin').'</button>',
		), 
		/*array(
			'type' => 'switch',
...
$fields_form[1]['form'] = array(
	'input' => array(
		...
		array(
			...
			'prefix' => 'px',
			'class' => 'fixed-width-lg',
			'desc' => $this->getTranslator()->trans('Leave it empty to use the default value 15.', array(), 'Admin.Theme.Panda'),
		),
		array(
			'type' => 'radio',
...
$fields_form[11]['form'] = array(
	...
	'input' => array(
        ...
        array(
            'type' => 'switch',
            'label' => $this->getTranslator()->trans('Hide navigation on mobile:', array(), 'Admin.Theme.Panda'),
		...
		array(
			...
			'values' => array(
				...
				array(
					...
					'value' => 1,
					'label' => $this->getTranslator()->trans('Accordions, product description opened by default.', array(), 'Modules.StThemeeditor.Admin')),
				array(
