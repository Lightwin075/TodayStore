        ...
        <section class="products_section" >
            <div class="products_slider {if $p_c.grid==1} display_as_grid {elseif $p_c.grid==2} display_as_simple {/if}">
                ...
                {if isset($p_c.products) && $p_c.products}
                    ...
                    {if isset($p_c.view_more) && $p_c.view_more && isset($p_c.link) && $p_c.link}<div class="product_view_more_box text-center"><a href="{$p_c.link}" class="btn btn-default btn-more-padding btn-large" title="{l s='View more' d='Shop.Theme.Panda'}">{l s='View more' d='Shop.Theme.Panda'}</a></div>{/if}
                {else}
