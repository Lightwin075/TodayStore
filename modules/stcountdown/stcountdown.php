...
class StCountDown extends Module
{
    ...
    public function getContent()
	{
		...
		if (isset($_POST['savestcountdown']))
		{
            ...
            if ($res)
            {
                ...
                $this->_html .= $this->displayError($this->getTranslator()->trans('Cannot update settings', array(), 'Admin.Theme.Panda'));  
        }
    ...
    public function initFieldsForm()
    {
        ...
        $this->fields_form[1]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Text font:', array(), 'Admin.Theme.Panda'),
                    'name' => 'text_font_list',
                    'onchange' => 'handle_font_change(this);',
                    'options' => array(
                        'optiongroup' => array (
                ...
                'text_font'=>array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Text font weight:', array(), 'Admin.Theme.Panda'),
                    'onchange' => 'handle_font_style(this);',
                    'class' => 'fontOptions',
                    'name' => 'text_font',
                    'options' => array(
                 ...
                 array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Text font size:', array(), 'Admin.Theme.Panda'),
                    'name' => 'font_size',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'validation' => 'isUnsignedInt',
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Divider color:', array(), 'Admin.Theme.Panda'),
                    'name' => 'divider_color',
                    'class' => 'color',
                    'size' => 20,
                    'validation' => 'isColor',
        ...
        $this->fields_form[2]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Text transform:', array(), 'Admin.Theme.Panda'),
                    'name' => 'pro_font_trans',
                    'options' => array(
                        'query' => self::$textTransform,
                        'id' => 'id',
    ...
    private function getConfigFieldsValues()
    {
        ...
        $this->fields_form[0]['form']['input']['products']['desc'] = $this->getTranslator()->trans('Actually only for "display on all special products" is set to "No".', array(), 'Admin.Theme.Panda').'<br/>'.$this->getTranslator()->trans('Current products', array(), 'Admin.Theme.Panda')
