...
return array(
	'setting' => array(
        ...
        'header_bottom_spacing'=>array(
            ...
            'desc' => $this->getTranslator()->trans('Set a spacing between header and content on the blog homepage.', array(), 'Admin.Theme.Panda'),
        ), 
    ...
    'blog_block' => array(
        ...
        'name_size' => array(
            'type' => 'text',
            'label' => $this->getTranslator()->trans('Name font size:', array(), 'Admin.Theme.Panda'),
            'name' => 'name_size',
            'default_value' => 16,
            'prefix' => 'px',
            'class' => 'fixed-width-lg',
        ...
        'display_read_more' => array(
            ...
            'values' => array(
                array(
                    ...
                    'value' => 1,
                    'label' => $this->getTranslator()->trans('Yes, display as buttons', array(), 'Admin.Theme.Panda')),
                array(
                    'id' => 'display_read_more_2',
                    'value' => 2,
                    'label' => $this->getTranslator()->trans('Yes, display as links', array(), 'Admin.Theme.Panda')),
                array(
                    'id' => 'display_read_more_0',
                    'value' => 0,
                    'label' => $this->getTranslator()->trans('No', array(), 'Admin.Theme.Panda')),
            ),
            'desc' => $this->getTranslator()->trans('Read more buttons display along with short content, which means if a block does not showing short content, read more buttons would also do not show out in this block.', array(), 'Admin.Theme.Panda'),
        ),
    ...
    'category' => array(
        ...
        'blog_image_type'=>array(
                'type' => 'select',
                'label' => $this->getTranslator()->trans('Image type:', array(), 'Admin.Theme.Panda'),
        ...
        'dropdownlistgroup' => array(
            ...
            'label' => $this->getTranslator()->trans('Articles per row in grid view:', array(), 'Admin.Theme.Panda'),
            'name' => 'pro_per_grid',
            'values' => array(
                    'maximum' => 12,
        ...
        'display_sd' => array(
            'type' => 'radio',
            'label' => $this->getTranslator()->trans('Display blog short content:', array(), 'Admin.Theme.Panda'),
            'name' => 'display_sd',
            'default_value' => 1,
            'values' => array(
                array(
                ...
                array(
                    'id' => 'display_sd_short',
                    'value' => 3,
                    'label' => $this->getTranslator()->trans('Short content, 120 characters', array(), 'Admin.Theme.Panda')),
                array(
                    'id' => 'display_sd_on',
                    'value' => 1,
                    'label' => $this->getTranslator()->trans('Short content, 220 characters', array(), 'Admin.Theme.Panda')),
                array(
                    'id' => 'display_sd_full',
                    'value' => 2,
                    'label' => $this->getTranslator()->trans('Full short content', array(), 'Admin.Theme.Panda')),
                array(
                    'id' => 'display_sd_4',
                    'value' => 4,
    ...
    'article' => array(
        'post_heading_size' => array(
            'type' => 'text',
            'label' => $this->getTranslator()->trans('Blog heading size:', array(), 'Admin.Theme.Panda'),
