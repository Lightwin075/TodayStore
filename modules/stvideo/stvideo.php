	...
	public function __construct()
	{
        ...
        self::$location = array(
            0 => array(
                'id' => 'location_0',
                'value' => 0,
                'label' => $this->getTranslator()->trans('All products', array(), 'Admin.Theme.Panda')
            ),
            1 => array(
                'id' => 'location_1',
                'value' => 1,
                'label' => $this->getTranslator()->trans('Specify products', array(), 'Admin.Theme.Panda')
            ),
            2 => array(
                'id' => 'location_2',
                'value' => 2,
                'label' => $this->getTranslator()->trans('By category', array(), 'Admin.Theme.Panda')
            ),
            3 => array(
                'id' => 'location_3',
                'value' => 3,
                'label' => $this->getTranslator()->trans('By manufacturer', array(), 'Admin.Theme.Panda')
            ),
        );
        self::$ratio = array(
            1 => array(
		...
		if (isset($_POST['save'.$this->name]) || isset($_POST['save'.$this->name.'AndStay']))
		{
			...
			if (!count($error) && $video->validateFields(false) && $video->validateFieldsLang(false))
            {
                ...
                if($video->save())
                {
                    ...
                    $this->_html .= $this->displayError($this->getTranslator()->trans('An error occurred during while', array(), 'Modules.StVideo.Admin').' '.($id_st_video ? $this->gettranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->gettranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
            }
            else
	...
	protected function initSettingForm()
	{
		$this->fields_form[0]['form'] = array(
			...
			'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon bacground opacity:', array(), 'Admin.Theme.Panda'),
                    'name' => 'bg_opacity',
                    'validation' => 'isFloat',
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon width:', array(), 'Admin.Theme.Panda'),
                    'name' => 'icon_width',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon height:', array(), 'Admin.Theme.Panda'),
                    'name' => 'icon_height',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'validation' => 'isUnsignedInt',
    ...
    protected function initForm()
	{
		...
		$this->fields_form[0]['form'] = array(
			...
			'input' => array(
                ...
                array(
					'type' => 'select',
					'label' => $this->getTranslator()->trans('Select a category', array(), 'Admin.Theme.Panda'),
					'name' => 'id_category',
                ...
                array(
					'type' => 'select',
					'label' => $this->getTranslator()->trans('Select a manufacturer', array(), 'Admin.Theme.Panda'),
        ...
        if ($type == 0) {
            $array = array(
                array(
					'type' => 'text',
					'label' => $this->getTranslator()->trans('URL:', array(), 'Admin.Theme.Panda'),
					'name' => 'url',
                    'required' => true,
                    'class' => 'fixed-width-xxl',
				),
        ...
        $this->fields_form[0]['form']['input']['products']['desc'] = $this->getTranslator()->trans('Type product name to add prodcuts:', array(), 'Modules.StVideo.Admin').'<br/>'.$this->getTranslator()->trans('Current products', array(), 'Admin.Theme.Panda')
