...
{elseif $stvideos.videos}
    ...
    {if in_array($video.video_position, $video_position) && $size_chart.url}
        <a class="st_popup_video {if $video.hide_on_mobile == 1} hidden-md-down {elseif $video.hide_on_mobile == 2} hidden-lg-up {/if} {if count(array_intersect(array(13,14,15), $video_position))} mar_b6 {else} pro_right_item {/if}" href="{$video.url}" title="{l s='View video' d='Shop.Theme.Panda'}" rel="nofollow">{l s='View video' d='Shop.Theme.Panda'}</a>
        <a class="st_popup_video {if $video.hide_on_mobile == 1} hidden-md-down {elseif $video.hide_on_mobile == 2} hidden-lg-up {/if} pro_right_item" href="{$video.url}" title="{l s='View video' d='Shop.Theme.Panda'}" rel="nofollow">{l s='View video' d='Shop.Theme.Panda'}</a>
    {/if}
    {/foreach}
{/if}