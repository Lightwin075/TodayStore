...
class StCustomerSignIn extends Module implements WidgetInterface
{
        ...
        $this->_hooks = array(
            'Hooks' => array(
                ...
                /*array(
                    'id' => 'displayMobileBar',
                    'val' => '1',
                    'name' => $this->getTranslator()->trans('Mobile Bar', array(), 'Admin.Theme.Panda').$this->getTranslator()->trans(' - User center(My account infomation, language switcher and search box)', array(), 'Admin.Theme.Panda'),
                ),
                array(
                    'id' => 'displayMobileBarLeft',
                    'val' => '1',
                    'name' => $this->getTranslator()->trans('Mobile Bar left', array(), 'Admin.Theme.Panda').$this->getTranslator()->trans(' - User center(My account infomation, language switcher and search box)', array(), 'Admin.Theme.Panda'),
                ),
                array(
                    'id' => 'displayMobileBarCenter',
                    'val' => '1',
                    'name' => $this->getTranslator()->trans('Mobile Bar center', array(), 'Admin.Theme.Panda').$this->getTranslator()->trans(' - User center(My account infomation, language switcher and search box)', array(), 'Admin.Theme.Panda'),
                ),
                array(
                    'id' => 'displayMobileBarBottom',
                    'val' => '1',
                    'name' => $this->getTranslator()->trans('Mobile Bar bottom', array(), 'Admin.Theme.Panda').$this->getTranslator()->trans(' - User center(My account infomation, language switcher and search box)', array(), 'Admin.Theme.Panda'),
                ),*/
                ...
                array(
        			...
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('Checkout page header', array(), 'Admin.Theme.Panda'),
                ...
                array(
                    ...
                    'values' => array(
                        ...
                        array(
                            ...
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('My account', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'userinfo_redirect_index',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Index', array(), 'Admin.Theme.Panda')),
                    ),
    ...
    public function getWidgetVariables($hookName, array $configuration)
    {
        ...
        $variables = array(
            ...
            'show_user_info_icons'    => Configuration::get('ST_SHOW_USER_INFO_ICONS'),
            'welcome_logged'    => Configuration::get('STSN_WELCOME_LOGGED'),
            'welcome_link'    => Configuration::get('STSN_WELCOME_LINK'),
            'welcome'    => Configuration::get('STSN_WELCOME'),
            'userinfo_login'    => Configuration::get('ST_USERINFO_LOGIN'),
