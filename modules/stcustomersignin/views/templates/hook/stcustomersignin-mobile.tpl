...
{if $logged}
    ...
    {/if}
    <li class="mo_ml_level_0 mo_ml_column">
        <a href="{$my_account_url}" rel="nofollow" class="mo_ma_level_0" title="{l s='View my customer account' d='Shop.Theme.Panda'}">
    ...
    <li class="mo_ml_level_0 mo_ml_column">
        <a href="{$logout_url}" rel="nofollow" class="mo_ma_level_0" title="{l s='Log me out' d='Shop.Theme.Panda'}">
            {if $show_user_info_icons}<i class="fto-logout mar_r4"></i>{/if}{l s='Sign out' d='Shop.Theme.Panda'}
        </a>
    </li>
{else}
    ...
    {/if}
    <li class="mo_ml_level_0 mo_ml_column">
        <a href="{$my_account_url}" title="{l s='Log in to your customer account' d='Shop.Theme.Panda'}" rel="nofollow" class="mo_ma_level_0">
            {if $show_user_info_icons}<i class="fto-user icon_btn mar_r4"></i>{/if}{l s='Login' d='Shop.Theme.Panda'}
        </a>
    </li>
{/if}
</ul>
