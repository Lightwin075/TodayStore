        ...
        $this->_hooks = array(
            'Hooks' => array(
        		...
        		/*array(
        			...
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('Footer bottom left', array(), 'Admin.Theme.Panda')
        		),
        		array(
        			'id' => 'displayFooterBottomRight',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('Footer bottom right', array(), 'Admin.Theme.Panda')
        		),*/
                array(
                ...
                array(
                    'id' => 'displayMobileNav',
                    'val' => '1',
                    'name' => $this->getTranslator()->trans('Mobile Nav', array(), 'Admin.Theme.Panda'),
                ),
            )
        );
    }
    ...
    protected function initFieldsForm()
    {
		$this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('How to display:', array(), 'Admin.Theme.Panda'),
                    ...
                    'values' => array(
                        ...
                        array(
                            ...
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Buttons', array(), 'Admin.Theme.Panda')),
                    ),
                    'validation' => 'isUnsignedInt',
                ),
			),
