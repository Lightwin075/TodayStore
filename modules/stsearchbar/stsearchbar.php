...
class StSearchbar extends Module implements WidgetInterface
{
    ...
    protected function initFieldsForm()
    {
		$this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Search box width in header:', array(), 'Admin.Theme.Panda'),
                ...
                array(
                    'type' => 'checkbox',
                    'label' => $this->getTranslator()->trans('Auto suggestion results', array(), 'Admin.Theme.Panda'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Auto suggestion size:', array(), 'Admin.Theme.Panda'),
                ...
                array(
                    ...
                    'values' => array(
                        array(
                            ...
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('A search icon', array(), 'Modules.StBanner.Admin')
                        ),
                        array(
                            'id' => 'quick_search_mobile_1',
                            'value' => 1,
                            'label' => $this->getTranslatOr()->trans('An input file. This is easy for customers to search ', array(), 'Modules.StBanner.Admin')
                        ),
                    ),
                    'validation' => 'isUnsignedInt',
                ),   
    ...
    public function getWidgetVariables($hookName, array $configuration = [])
    {
        $widgetVariables = array(
            ...
            'quick_search_simple' => ($hookName=='displayMobileNav') ? 0 : Configuration::get('ST_QUICK_SEARCH_SIMPLE'),
