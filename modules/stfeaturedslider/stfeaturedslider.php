...
class StFeaturedSlider extends BaseProductsSlider
{
	...
	function __construct()
	{
		...
		$this->version        = '1.1.8';
        $this->title          = $this->getTranslator()->trans('Featured Products', array(), 'Shop.Theme.Panda'); // Front office title block.
	...
	function install()
	{
		if (!parent::install() 
            ...
            || !Configuration::updateValue($this->_prefix_st.'TITLE_ALIGN', 1) 
            || !Configuration::updateValue($this->_prefix_st.'TITLE_BOTTOM_BORDER', 0) 
