...
*}
                    ...
                    {if $blog.content_short}<p class="blok_blog_short_content">{$blog.content_short|strip_tags:'UTF-8'}<a href="{$blog.link}" title="{l s='Read More' d='Shop.Theme.Panda'}" class="go">{l s='Read More' d='Shop.Theme.Panda'}</a></p>{/if}
                    <div class="blog_info">
