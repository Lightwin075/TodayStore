                    ...
                    array(
                        ...
                        'values' => array(
                            array(
                                ...
                                'value' => 0,
                                'label' => $this->getTranslator()->trans('Large, a specail bag-like cart icon', array(), 'Modules.StShoppingcart.Admin')),
                            array(
                                'id' => 'block_cart_style_big_icon',
                                'value' => 2,
                                'label' => $this->getTranslator()->trans('Large, default cart icon', array(), 'Modules.StShoppingcart.Admin')),
                            array(
                            ...
                            array(
                                ...
                                'value' => 3,
                                'label' => $this->getTranslator()->trans('Small, default cart icon', array(), 'Modules.StShoppingcart.Admin')),
                        ),
                    ),
                    array(
                        'type' => 'checkbox',
