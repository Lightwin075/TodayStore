      ...
      <div class="modal-body modal_cart general_border">
        ...
        <div class="modal_cart_details">
            ...
            <div class="cart-content-btn row">
                ...
                <div class="col-md-6">
                    <a href="{$cart_url}" class="btn btn-default btn-full-width" rel="nofollow" title="{l s='Proceed to checkout' d='Shop.Theme.Panda'}">{l s='Proceed to checkout' d='Shop.Theme.Panda'}</a>
                </div>
            </div>
