...
{/foreach}
	{if $id_customer|intval neq 0}
        ...
        <h3 class="page_heading">{l s='My loved products' d='Shop.Theme.Panda'}</h3>
            ...
            <div class="pro_simple_box clearfix">
                ...
                <div class="itemlist_right">
                    ...
                    {block name='product_price_and_shipping'}
                      ...
                      {/if}
                    {/block}
                    <a href="javascript:;" title="{l s='Delete' d='Shop.Theme.Panda'}" class="btn-spin loved_remove_product" rel="nofollow"><i class="fto-cancel mar_r4"></i>{l s='Delete' d='Shop.Theme.Panda'}</a>   
                </div>
            </div>
            </li>
            {/foreach}
        ...
        <h3 class="page_heading">{l s='My loved articles' d='Shop.Theme.Panda'}</h3>
        <ul class="com_grid_view row">
