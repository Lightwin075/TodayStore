...
<nav class="st-menu" id="side_loved">
	...
	<div id="side_loved_block" class="pad_10">
		{if $customer.is_logged && !$customer.is_guest}
			...
			{/if}
		{else}
			<p>{l s='Create a free account to save loved products and articles.' d='Shop.Theme.Panda'}</p>
  			<div class="text-center"><a href="{$urls.pages.authentication}" class="btn btn-default btn-more-padding" title="{l s='Sign in' d='Shop.Theme.Panda'}">{l s='Sign in' d='Shop.Theme.Panda'}</a></div>
		{/if}
	</div>
</nav>