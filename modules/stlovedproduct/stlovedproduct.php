...
class StLovedProduct extends Module implements WidgetInterface
{
    ...
    {
        $this->_tabs = array(
            array('id'  => '0,1,5', 'name' => $this->getTranslator()->trans('General settings', array(), 'Admin.Theme.Panda')),
        ...
        $this->_hooks = array(
            ...
            'Blog page' => array(
                array(
                    ...
                    'val' => '1',
                    'name' => $this->getTranslator()->trans('displayStBlogArticleInfo', array(), 'Admin.Theme.Panda'),
                    'is_blog' => 1,
                ),
                array(
                    ...
                    array(
                        ...
                        'values' => array(
                            array(
                                'id' => 'type_1',
                                'value' => 1,
                                'label' => $this->getTranslator()->trans('Product', array(), 'Admin.Theme.Panda')),
                            array(
                                'id' => 'type_2',
                                'value' => 2,
                                'label' => $this->getTranslator()->trans('Blog', array(), 'Admin.Theme.Panda')),
                        ),
        ...
        $this->fields_form[0]['form'] = array(
			...
			'input' => array(
                ...
                /*array(
                    ...
                    'name' => 'minimal_time',
                    'prefix' => $this->getTranslator()->trans('Seconds', array(), 'Admin.Theme.Panda'),
                    'default_value' => 10,
                    'validation' => 'isUnsignedInt',
        ...
        $this->fields_form[5]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'validation' => 'isBool',
                    'desc' => $this->getTranslator()->trans('For cacheing reason the number of loved products can only be display on the product page.', array(), 'Admin.Theme.Panda'),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon size:', array(), 'Admin.Theme.Panda'),
                ...
                /*array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Total number color:', array(), 'Admin.Theme.Panda'),
                    'name' => 'number_color',
                    'size' => 33,
                    'validation' => 'isColor',
                ),
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Total number background color:', array(), 'Admin.Theme.Panda'),
    ...
    public function renderList($type=1)
    {
        $fields_list = array(
            ...
            'id_source' => array(
                'title' => $type == 1 ? $this->trans('Products', array(), 'Admin.Theme.Panda') : $this->trans('Articles', array(), 'Admin.Theme.Panda'),
                'class' => 'fixed-width-xxl',
                'type' => 'text',
            ...
            'total' => array(
                'title' => $this->trans('Loved', array(), 'Admin.Theme.Panda'),
                'class' => 'fixed-width-xxl',
                'type' => 'text',
    ...
    public static function displayLovedForm($value, $tr)
    {
        return '<input name="loved_'.(int)$tr['id_source'].'_'.(int)$tr['type'].'" value="'.(int)$value.'" size="6" />
            ...
            data-label="'.Context::getContext()->getTranslator()->trans('Save', array(), 'Admin.Theme.Panda').'"
            data-doing="'.Context::getContext()->getTranslator()->trans('Saving', array(), 'Admin.Theme.Panda').'"  
            value="'.Context::getContext()->getTranslator()->trans('Save', array(), 'Admin.Theme.Panda').'" />';
    }
