...
class StMegaMenu extends Module implements WidgetInterface
{
        ...
        $this->_hooks = array(
            'Hooks' => array(
                array(
                    'id' => 'displayMainMenu',
                    'val' => '1',
                    'name' => $this->getTranslator()->trans('displayMainMenu', array(), 'Admin.Theme.Panda')
                ),
                /*array(
        			'id' => 'displayLeftColumn',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('displayLeftColumn', array(), 'Admin.Theme.Panda')
        		),
        		array(
        			'id' => 'displayRightColumn',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('displayRightColumn', array(), 'Admin.Theme.Panda')
        		),*/
                array(
        			'id' => 'displayTop',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('displayTop(displayHeaderRight)', array(), 'Admin.Theme.Panda')
        		),
        		array(
        		...
        		/*array(
        			'id' => 'displayLeftBar',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('displayLeftBar', array(), 'Admin.Theme.Panda')
        		),
        		array(
        			'id' => 'displayRightBar',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('displayRightBar', array(), 'Admin.Theme.Panda')
        		),*/
                array(
        			'id' => 'displayMobileNav',
        			'val' => '1',
                ...
                /*array(
        			'id' => 'displayMobileBar',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('displayMobileBar', array(), 'Admin.Theme.Panda')
        		),
                array(
        			'id' => 'displayMobileBarLeft',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('displayMobileBarLeft', array(), 'Admin.Theme.Panda')
        		),
                array(
        			'id' => 'displayMobileBarCenter',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('displayMobileBarCenter', array(), 'Admin.Theme.Panda')
        		),
                array(
        			'id' => 'displayMobileBarBottom',
        			'val' => '1',
        			'name' => $this->getTranslator()->trans('displayMobileBarBottom', array(), 'Admin.Theme.Panda')
        		),*/
            ),
        );
    }
    ...
    private function _checkImageDir()
    {
        ...
        if (!is_writable(_PS_MODULE_DIR_.$this->name.'/views/css'))
            $this->_html .= $this->displayError('"'._PS_MODULE_DIR_.$this->name.'/views/css'.'" '.$this->getTranslator()->trans('directory isn\'t writable.', array(), 'Admin.Theme.Panda'));
	...
	public function getContent()
	{
            ...
            if (!count($error) && $menu->validateFields(false) && $menu->validateFieldsLang(false))
            {
                if($menu->save())
                {
                    ...
                    if(isset($_POST['savestmegamenuAndStay']) || Tools::getValue('fr') == 'view')
                    {
                        ...
                        $this->_html .= $this->displayConfirmation($this->getTranslator()->trans('Main menu', array(), 'Admin.Theme.Panda').' '.($id_st_mega_menu ? $this->getTranslator()->trans('updated', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('added', array(), 'Admin.Theme.Panda')));
                }
                else
                    $this->_html .= $this->displayError($this->getTranslator()->trans('An error occurred during main menu', array(), 'Admin.Theme.Panda').' '.($id_st_mega_menu ? $this->getTranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
            }
			else
        ...
        if (isset($_POST['savecolumnstmegamenu']) || isset($_POST['savecolumnstmegamenuAndStay']))
		{
            ...
            if (!count($error) && $column->validateFields(false) && $column->validateFieldsLang(false))
            {
                if($column->save())
                {
                    ...
                    $this->_html .= $this->displayError($this->getTranslator()->trans('An error occurred during menu', array(), 'Admin.Theme.Panda').' '.($id_st_mega_column ? $this->getTranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
            }
            else
        ...
        if (isset($_POST['savecustomlinkstmegamenu']) || isset($_POST['savecustomlinkstmegamenuAndStay']))
        {
            ...
            if (!count($error) && $menu->validateFields(false) && $menu->validateFieldsLang(false))
            {
                if($menu->save())
                {
                    ...
                    $this->_html .= $this->displayError($this->getTranslator()->trans('An error occurred during menu', array(), 'Admin.Theme.Panda').' '.($id_st_mega_menu ? $this->getTranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
            }
			else
				$this->_html .= count($error) ? implode('',$error) : $this->displayError($this->getTranslator()->trans('Invalid value for field(s).', array(), 'Admin.Theme.Panda'));
        }
		if (isset($_POST['savecustomcontentstmegamenu']) || isset($_POST['savecustomcontentstmegamenuAndStay']))
        {
            ...
            if (!count($error) && $menu->validateFields(false) && $menu->validateFieldsLang(false))
            {
                if($menu->save())
                {
                    ...
                    $this->_html .= $this->displayError($this->getTranslator()->trans('An error occurred during custom content', array(), 'Admin.Theme.Panda').' '.($id_st_mega_menu ? $this->getTranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
            }
			else
				$this->_html .= count($error) ? implode('',$error) : $this->displayError($this->getTranslator()->trans('Invalid value for field(s).', array(), 'Admin.Theme.Panda'));
        }
        if (isset($_POST['savecategorystmegamenu']) || isset($_POST['savecategorystmegamenuAndStay']))
        {
            ...
            if(!$menu->id_st_mega_column)
                $error[] = $this->displayError($this->getTranslator()->trans('An error occurred.', array(), 'Admin.Theme.Panda'));
            ...
            if (!count($error) && $menu->validateFields(false) && $menu->validateFieldsLang(false))
            {
                if($menu->save())
                {
                    ...
                    $this->_html .= $this->displayError($this->getTranslator()->trans('An error occurred during menu item', array(), 'Admin.Theme.Panda').' '.($id_st_mega_menu ? $this->getTranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
            }
            else
                $this->_html .= count($error) ? implode('',$error) : $this->displayError($this->getTranslator()->trans('Invalid value for field(s).', array(), 'Admin.Theme.Panda'));
        }
    ...
    {
        return array(
            'my-account' => array('id'=>'10_my-account', 'name'=>$this->getTranslator()->trans('My account', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('Manage my customer account', array(), 'Admin.Theme.Panda')),
            'order-follow' => array('id'=>'10_history', 'name'=>$this->getTranslator()->trans('My orders', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('My orders', array(), 'Admin.Theme.Panda')),
            'order-follow' => array('id'=>'10_order-follow', 'name'=>$this->getTranslator()->trans('My merchandise returns', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('My returns', array(), 'Admin.Theme.Panda')),
            'order-slip' => array('id'=>'10_order-slip', 'name'=>$this->getTranslator()->trans('My credit slips', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('My credit slips', array(), 'Admin.Theme.Panda')),
            'addresses' => array('id'=>'10_addresses', 'name'=>$this->getTranslator()->trans('My addresses', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('My addresses', array(), 'Admin.Theme.Panda')),
            'identity' => array('id'=>'10_identity', 'name'=>$this->getTranslator()->trans('My personal info', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('Manage my personal information', array(), 'Admin.Theme.Panda')),
            'discount' => array('id'=>'10_discount', 'name'=>$this->getTranslator()->trans('My vouchers', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('My vouchers', array(), 'Admin.Theme.Panda')),
        );
    }
    ...
    {
        return array(
            'prices-drop' => array('id'=>'10_prices-drop', 'name'=>$this->getTranslator()->trans('Specials', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('Specials', array(), 'Admin.Theme.Panda')),
            'new-products' => array('id'=>'10_new-products', 'name'=>$this->getTranslator()->trans('New products', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('New products', array(), 'Admin.Theme.Panda')),
            'best-sales' => array('id'=>'10_best-sales', 'name'=>$this->getTranslator()->trans('Top sellers', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('Top sellers', array(), 'Admin.Theme.Panda')),
            'stores' => array('id'=>'10_stores', 'name'=>$this->getTranslator()->trans('Our stores', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('Our stores', array(), 'Admin.Theme.Panda')),
            'contact' => array('id'=>'10_contact', 'name'=>$this->getTranslator()->trans('Contact us', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('Contact us', array(), 'Admin.Theme.Panda')),
            'sitemap' => array('id'=>'10_sitemap', 'name'=>$this->getTranslator()->trans('Sitemap', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('Sitemap', array(), 'Admin.Theme.Panda')),
            'manufacturer' => array('id'=>'10_manufacturer', 'name'=>$this->getTranslator()->trans('Manufacturers', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('Manufacturers', array(), 'Admin.Theme.Panda')),
            'supplier' => array('id'=>'10_supplier', 'name'=>$this->getTranslator()->trans('Suppliers', array(), 'Admin.Theme.Panda'), 'title'=>$this->getTranslator()->trans('Suppliers', array(), 'Admin.Theme.Panda')),
        );
    }
    ...
    public function createLinks($icon=true)
    {
        ...
        $links = array(
            ...
            /*array('name'=>$this->getTranslator()->trans('Products', array(), 'Admin.Theme.Panda'),'query'=>array(
                array('id'=>'2_0', 'name'=>$this->getTranslator()->trans('Choose ID product', array(), 'Admin.Theme.Panda')),
            )),*/
        );
        if($icon)
            array_unshift($links,array('name'=>$this->getTranslator()->trans('Icon', array(), 'Admin.Theme.Panda'),'query'=>array(
                array('id'=>'7_1', 'name'=>$this->getTranslator()->trans('Home icon', array(), 'Admin.Theme.Panda')),
            )));
        return $links;
    }
	...
	private function initForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Open in a new window:', array(), 'Admin.Theme.Panda'),
                    'name' => 'new_window',
                    'is_bool' => true,
                    'default_value' => 0,
                    'values' => array(
                ...
                array(
					...
					'values' => array(
						array(
							'id' => 'hide_on_mobile_0',
							'value' => 0,
							'label' => $this->getTranslator()->trans('Visible on all devices', array(), 'Admin.Theme.Panda')),
						array(
							'id' => 'hide_on_mobile_1',
							'value' => 1,
							'label' => $this->getTranslator()->trans('Visible on large devices (screen width > 992px)', array(), 'Admin.Theme.Panda')),
                        array(
							'id' => 'hide_on_mobile_2',
							'value' => 2,
							'label' => $this->getTranslator()->trans('Visible on small devices (screen width < 992px)', array(), 'Admin.Theme.Panda')),
					),
                ),
                array(
                    'type' => 'text',
        ...
        $this->fields_form[1]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Link background color:', array(), 'Admin.Theme.Panda'),
                    'name' => 'bg_color',
                    'class' => 'color',
                    'size' => 20,
                ), 
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Link hover background color:', array(), 'Admin.Theme.Panda'),
                    'name' => 'bg_color_over',
                    'class' => 'color',
                    'size' => 20,
                ), 
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Submenu background color:', array(), 'Admin.Theme.Panda'),
                    'name' => 'tab_content_bg',
                    'class' => 'color',
                    'size' => 20,
                ), 
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Label:', array(), 'Admin.Theme.Panda'),
                    'name' => 'cate_label',
                    'size' => 64,
                    'lang' => true,
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Lable color:', array(), 'Admin.Theme.Panda'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Lable background:', array(), 'Admin.Theme.Panda'),
                    'name' => 'cate_label_bg',
                    'class' => 'color',
                    'size' => 20,
                ), 
                ...
                array(
                    ...
                    'values' => array(
                        array(
                            'id' => 'bg_position_rb',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('right bottom', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'bg_position_rt',
                            'value' => 4,
                            'label' => $this->getTranslator()->trans('right top', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'bg_position_rc',
                            'value' => 5,
                            'label' => $this->getTranslator()->trans('right center', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'bg_position_lt',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('left top', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'bg_position_lc',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('left center', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'bg_position_lb',
                            'value' => 3,
                            'label' => $this->getTranslator()->trans('left bottom', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'bg_position_ct',
                            'value' => 6,
                            'label' => $this->getTranslator()->trans('center top', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'bg_position_cc',
                            'value' => 7,
                            'label' => $this->getTranslator()->trans('center center', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'bg_position_cb',
                            'value' => 8,
                            'label' => $this->getTranslator()->trans('center bottom', array(), 'Admin.Theme.Panda')),
                    ),
                    'validation' => 'isUnsignedInt',
                ),
                 array(
    ...
    public function initCategoryForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                'links' => array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Categories:', array(), 'Admin.Theme.Panda'),
                    'name' => 'links',
                    'required' => true,
                    'options' => array(
                        ...
                        'default' => array(
                            'value' => '',
                            'label' => $this->getTranslator()->trans('Select category', array(), 'Admin.Theme.Panda'),
                        ),
                    )
                ),
                'title' => array(
                ...
                array(
                    ...
                    'values' => array(
                        ...
                        array(
                            'id' => 'subtype_products',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Products', array(), 'Admin.Theme.Panda')
                        ),
                        array(
                            'id' => 'subtype_products',
                            'value' => 3,
    ...
    public function initProductForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Product', array(), 'Admin.Theme.Panda'),
                'icon' => 'icon-cogs'
            ),
            'input' => array(
                'product_name' => array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Product name:', array(), 'Admin.Theme.Panda'),
                    'name' => 'product_name',
                    'autocomplete' => false,
                    'desc' => $this->getTranslator()->trans('Current product', array(), 'Admin.Theme.Panda').': <ul id="curr_product_name">'.$product_div.'</ul>',
                ),
                array(
                    'type' => 'hidden',
    ...
    public function initBrandForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Type:', array(), 'Admin.Theme.Panda'),
                    'name' => 'subtype',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'subtype_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Image', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'subtype_1',
                            'value' => 1,
    ...
    public function initCustomLinkForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Custom link', array(), 'Admin.Theme.Panda'),
                'icon' => 'icon-cogs'
            ),
            'input' => array(
                array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Parent:', array(), 'Admin.Theme.Panda'),
                    'name' => 'id_parent',
                    'options' => array(
                        'query' => $parents_arr,
                        'id' => 'id',
                        ...
                        'default' => array(
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Please select', array(), 'Admin.Theme.Panda')
                        )
                    )
                ),
                'links' => array(
    ...
    public function initCustomContentForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Custom content', array(), 'Admin.Theme.Panda'),
                'icon' => 'icon-cogs'
            ),
            'input' => array(
                array(
    ...
    private function getBlogCategoryOption(&$blog_category_arr, $blog_categories)
    {
        ...
        foreach($blog_categories as $category)
        {
            ...
            if($category['id_parent']==0 && $category['is_root_category'])
		        $name = $module->getTranslator()->trans('Blog', array(), 'Admin.Theme.Panda');
            else
                $name = $category['name'].$module->getTranslator()->trans(' (Category)', array(), 'Admin.Theme.Panda');
    ...
    public static function displayTitle($value, $row)
	{
        ...
        switch($row['item_k'])
        {
			...
			case 7:
                $module = new StMegaMenu();
				return $module->getTranslator()->trans('Home icon', array(), 'Admin.Theme.Panda');
			break;
			case 8:
	            if(Module::isInstalled('stblog') && Module::isEnabled('stblog'))
				{
    ...
    protected function initList()
	{
		$this->fields_list = array(            
            ...
            'location' => array(
                'title' => $this->getTranslator()->trans('Display on', array(), 'Admin.Theme.Panda'),
                'width' => 140,
                'type' => 'text',
    ...
    {
        return '<li class="divider"></li><li><a href="'.AdminController::$currentIndex.'&configure='.$this->name.'&copy'.$this->name.'&id_st_mega_menu='.(int)$id.'&token='.$token.'"><i class="icon-copy"></i>'.$this->getTranslator()->trans(' Duplicate ', array(), 'Admin.Theme.Panda').'</a></li>';
    }
    ...
    public function initColumnList()
    {
        ...
        $helper->tpl_vars['navigate'] = array(
            '<a href="'.AdminController::$currentIndex.'&configure='.$this->name.'&token='.Tools::getAdminTokenLite('AdminModules').'">'.$this->getTranslator()->trans("Home", array(), 'Admin.Theme.Panda').'</a>',
    ...
    private function initColumnForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Column', array(), 'Admin.Theme.Panda'),
                'icon' => 'icon-cogs'
            ),
            'input' => array(
                'column_width' => array(
    ...
    public static function displayContent($value, $row)
    {
        ...
        {
            $module = new StMegaMenu();
            return $module->getTranslator()->trans('Custom content', array(), 'Admin.Theme.Panda');
        }
    }
    ...
    public static function displayItemTitle($value, $row)
    {
        ...
        switch ($row['item_t']) {
            ...
            case 3:
                ...
                {
                    $module = new StMegaMenu();
                    $res = $module->getTranslator()->trans('All', array(), 'Admin.Theme.Panda');
                }
                else
                {
    ...
    public function initMenuList()
    {
        ...
        $this->fields_list = array(
            ...
            'link' => array(
                'title' => $this->getTranslator()->trans('Link', array(), 'Admin.Theme.Panda'),
                'width' => 140,
                'type' => 'text',
                'search' => false,
                'orderby' => false,
        ...
        if (isset($_FILES[$item]) && isset($_FILES[$item]['tmp_name']) && !empty($_FILES[$item]['tmp_name']))
		{
				...
				in_array($type, array('jpg', 'gif', 'jpeg', 'png')))
			{
				...
				elseif (!$temp_name || !move_uploaded_file($_FILES[$item]['tmp_name'], $temp_name))
					$result['error'][] = $this->displayError($this->getTranslator()->trans('An error occurred during move image.', array(), 'Admin.Theme.Panda'));
				else{
                   ...
                   if(!ImageManager::resize($temp_name, _PS_UPLOAD_DIR_.$this->name.'/'.$c_name.'.'.$type, null, null, $type) || !ImageManager::resize($temp_name, _PS_UPLOAD_DIR_.$this->name.'/'.$c_name_thumb.'.'.$type, $ratio_x, $ratio_y, $type))
				       $result['error'][] = $this->displayError($this->getTranslator()->trans('An error occurred during the image upload.', array(), 'Admin.Theme.Panda'));
				} 
				if (isset($temp_name))
					@unlink($temp_name);
