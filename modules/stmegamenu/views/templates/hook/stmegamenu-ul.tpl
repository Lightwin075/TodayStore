<ul class="st_mega_menu clearfix mu_level_0">
	{if isset($stvertical) && count($stvertical)}
		...
		<li id="st_menu_0" class="ml_level_0 {if Configuration::get('STSN_MENU_VER_OPEN')}menu_ver_open_{if $responsive_max==1}lg{elseif $responsive_max==2}xl{elseif $responsive_max==3}xxl{else}md{/if}{/if}">
			<a id="st_ma_0" href="javascript:;" class="ma_level_0" title="{l s='Categories' d='Shop.Theme.Panda'}" rel="nofollow"><i class="fto-menu"></i>{l s='Categories' d='Shop.Theme.Panda'}</a>
