...
<section id="st_brand_slider-footer_{$hook_hash}" class="block col-sm-12 col-md-3">
    <div class="title_block"><div class="title_block_inner">{l s='Product Brands' d='Shop.Theme.Panda'}</div><a href="javascript:;" class="opener dlm">&nbsp;</a></div>
    ...
    {else}
        <p class="warning">{l s='No product Brands' d='Shop.Theme.Panda'}</p>
    {/if}
    </div>
</section>
<!-- /Brand slider footer  -->