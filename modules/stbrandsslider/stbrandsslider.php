...
class StBrandsSlider extends BaseSlider implements WidgetInterface
{
    ...
    protected function initTabNames()
    {
        $this->_tabs = array(
            ...
            array('id'  => '1,4', 'name' => $this->getTranslator()->trans('Homepage', array(), 'Admin.Theme.Panda')),
    ...
    public function initFieldsForm()
    {
        ...
        $fields['home_slider']['grid']['label'] = $this->getTranslator()->trans('How to display brands:', array(), 'Admin.Theme.Panda');
        $fields['home_slider']['nbr']['label'] = $this->getTranslator()->trans('Define the number of brands to be displayed:', array(), 'Admin.Theme.Panda');
        $fields['home_slider']['spacing_between']['label'] = $this->getTranslator()->trans('Spacing between brands:', array(), 'Admin.Theme.Panda');
        $fields['home_slider']['spacing_between']['desc'][0] = $this->getTranslator()->trans('Distance between brands.', array(), 'Admin.Theme.Panda');
        $fields['home_slider']['link_hover_color']['label'] = $this->getTranslator()->trans('Brands name hover color:', array(), 'Admin.Theme.Panda');
        ...
        $fields['column']['display_pro_col']['label'] = $this->getTranslator()->trans('How to display brands:', array(), 'Admin.Theme.Panda');
        $fields['column']['nbr_col']['label'] = $this->getTranslator()->trans('Define the number of brands to be displayed:', array(), 'Admin.Theme.Panda');
        $fields['column']['items_col']['label'] = $this->getTranslator()->trans('How many brands per view on compact slider:', array(), 'Admin.Theme.Panda');
        $fields['column']['soby_col']['default_value'] = 1;
        unset($fields['column']['aw_display_col']);
        $this->fields_form[2]['form'] = array(
			'legend' => array(
				'title' => $this->getTranslator()->trans('Slide on left column/right column', array(), 'Admin.Theme.Panda'),
			),
			'input' => $fields['column'],
			'submit' => array(
				'title' => $this->getTranslator()->trans('Save all', array(), 'Admin.Theme.Panda')
