...
<section class="products_section">
    ...
    <div class="title_block flex_container title_align_{(int)$title_position} title_style_{(int)$sttheme.heading_style}">
        ...
        <a href="{url entity='module' name='stproductcomments' controller='list'}" title="{l s='Testimonial' d='Shop.Theme.Panda'}" class="title_block_inner">{l s='Testimonial' d='Shop.Theme.Panda'}</a>
    ...
    {if isset($pcomments) && is_array($pcomments) && count($pcomments)}
        <div class="block_content {if $content_width} width_{$content_width} {/if} static_bullets">
    ...
    {else}
        <p class="warning">{l s='No comments' d='Shop.Theme.Panda'}</p>
    {/if}
</section>
