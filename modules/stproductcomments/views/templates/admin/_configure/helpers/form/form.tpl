	...
	{if $input.type == 'fontello'}
		<div class="fontello_wrap">
			<a id="btn_{$input.name}" class="btn btn-default" data-toggle="modal" href="#" data-target="#modal_{$input.name}">
				<i class="{if $fields_value[$input.name] && array_key_exists($fields_value[$input.name], $input.values.classes)}{$input.values.classes[$fields_value[$input.name]]}{/if}"></i>{l s='Edit' d='Admin.Theme.Panda'}
			</a>
