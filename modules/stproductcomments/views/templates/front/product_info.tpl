...
<div class="row mb-3">
    ...
    <div class="col-md-4">
        <div class="mb-2 flex_box flex_left">
            ...
            <a href="{url entity='module' name='stproductcomments' controller='list' params=['id_product' => $product.id_product]}" title="{l s='View all reivews' d='Shop.Theme.Panda'}" class="mr-2">{$nbComments} {if $nbComments==1}{l s='Review' d='Shop.Theme.Panda'}{else}{l s='Reviews' d='Shop.Theme.Panda'}{/if}</a>
        </div>
