  ...
  <section id="main" {if $sttheme.google_rich_snippets} itemscope itemtype="http://schema.org/Product" {/if}>
    ...
    {include file='module:stproductcomments/views/templates/front/product_info.tpl'}
        ...
        <div class="general_top_border pt-3">
            ...
            <div class="alert alert-warning" role="alert" data-alert="warning">{l s='Your comment is awaiting moderation before being published.' d='Shop.Theme.Panda'}</div>
            {else}
            ...
            <form name="st_product_comment_reply_form">
                <div class="form-group row">
                  <div class="col-md-4">
                      <input type="text" name="customer_name" placeholder="{l s='Enter your name' d='Shop.Theme.Panda'}" class="form-control" value="{$customerName}" />
                  </div>
                </div>
                ...
                {/if}
                <div class="clearfix">
                    <input type="submit" name="st_product_comment_reply_submit" class="st_product_comment_reply_submit btn btn-default js-submit-active fr" value="{l s='Submit' d='Shop.Theme.Panda'}" />
                </div>
            </form>
            </div>
