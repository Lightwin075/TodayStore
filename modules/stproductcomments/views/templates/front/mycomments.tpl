        ...
        <div class="col-12 col-md-4">
            <div class="row">
                ...
                <div class="col-5 col-md-6">
                    ...
                    <a href="{url entity='module' name='stproductcomments' controller='mycomments' params=['secure_key'=>$secure_key, 'id_st_product_comment'=>$product.st_product_comment.id_st_product_comment, 'delete_comment'=>1]}" title="{l s='Delete comment' d='Shop.Theme.Panda'}">{l s='Delete comment' d='Shop.Theme.Panda'}</a>
