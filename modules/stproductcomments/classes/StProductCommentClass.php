...
class StProductCommentClass extends ObjectModel
{
    ...
    public static function getCommentImages($id_st_product_comment)
    {
        $ret = array();
        if ($res = Db::getInstance()->executeS('
            ...
            foreach($res AS $value) {
                ...
                $ret[] = context::getContext()->link->protocol_content.Tools::getMediaServer($image).$image; 
            }
        }
        return $ret;
    }
	...
	{
	 	if (!is_array($to_delete) || !$id_st_product_comment)
