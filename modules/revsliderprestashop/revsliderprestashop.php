...
//        require_once ABSPATH . "/inc_php/framework/update.class.php";
    ...
    {
        if(($hookName=='displayFullWidthTop' || $hookName=='displayFullWidthTop2' || $hookName=='displayFullWidthBottom' || $hookName=='displayFooterBefore') && Dispatcher::getInstance()->getController()!='index')
              return false;
