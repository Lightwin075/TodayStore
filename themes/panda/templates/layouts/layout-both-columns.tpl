...
<html lang="{$language.iso_code}">
    ...
    <div class="loader-box">
        ...
        <ul class="labels">
            <li class="label">Teléfonos... </li>
            <li class="label">Tecnología... </li>
            <li class="label">Electrodomésticos... </li>
            <li class="label">Ropa y accesorios... </li>
        </ul>
    </div>
                        ...
                        {if isset($sttheme.boxstyle) && $sttheme.boxstyle==2}<div id="page_wrapper">{/if}
                            ...
                            <section id="wrapper" class="columns-container">
                                <div id="columns" class="container">
                                    <div class="row">
                                        ...
                                        {block name="left_column"}
                                            ...
                                            <div id="left_column" class="main_column {if $sttheme.slide_lr_column} col-8 {else} col-12 {/if} col-lg-{$sttheme.left_column_size_md} col-xl-{$sttheme.left_column_size_lg}">
                                    ...
                                    {block name="right_column"}
                                        ...
                                        <div id="right_column" class="main_column {if $sttheme.slide_lr_column} col-8 {else} col-12 {/if} col-lg-{$sttheme.right_column_size_md} col-xl-{$sttheme.right_column_size_lg}">
                                            <div class="wrapper-sticky">
                                                <div class="main_column_box">
                                                    {if $page.page_name == 'product'}
                                ...
                                {block name="content_wrapper"}
                                    <div id="center_column" class="col-lg-{$cols_md|intval} col-xl-{$cols_lg|intval}">
                                        {block name="content"}
