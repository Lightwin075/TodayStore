...
<div id="js-product-list-top" class="products-selection flex_container general_top_border general_bottom_border">
  ...
  <div class="list_grid_switcher">
    <div class="grid {if !$sttheme.list_grid} selected {/if}" title="{l s='Grid view' d='Shop.Theme.Panda'}"><i class="fto-th-large-1"></i></div>
    <div class="list {if $sttheme.list_grid} selected {/if}" title="{l s='List view' d='Shop.Theme.Panda'}"><i class="fto-th-list-1"></i></div>
  </div>
  {/if}
