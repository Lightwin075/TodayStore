      ...
      <div id="mobile_bar_top" class="flex_container">
          ...
          <div id="mobile_bar_right">
            <div class="flex_container">
              <a class="checkout_mobile_bar_tri mobile_bar_item mobile_bar_tri" data-name="checkout_mobile_nav" data-direction="open_bar_right" href="javascript:;" rel="nofollow" title="{l s='Menu' d='Shop.Theme.Panda'}">
                  <i class="fto-menu fs_xl"></i>
                  <span class="mobile_bar_tri_text">{l s='Menu' d='Shop.Theme.Panda'}</span>
              </a>
            </div>
          </div>
      </div>
