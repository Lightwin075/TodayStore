...
<div class="product-line-grid container-fluid">
  ...
  <div class="product-line-grid-left col-md-2 col-3">
    <span class="product-image media-middle">
      <img src="{$product.cover.bySize.cart_default.url}" width="{$product.cover.bySize.cart_default.width}" height="{$product.cover.bySize.cart_default.height}" alt="{$product.name|escape:'quotes'}" />
    </span>
  </div>
