        ...
        <section id="register_form_block" class="from_blcok block login_form_block">
          ...
          <div class="form_content">
            <div class="form_content_inner">
                <p>
                  {l s='Already have an account?' d='Shop.Theme.Customeraccount'} <a href="{$urls.pages.authentication}" rel="no-follow" title="{l s='Log in instead!' d='Shop.Theme.Customeraccount'}">{l s='Log in instead!' d='Shop.Theme.Customeraccount'}</a>
                </p>
