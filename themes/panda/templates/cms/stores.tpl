        ...
        <div class="store-item-container row">
          ...
          <div class="col-md-5 col-sm-12 store-description">
            ...
            {if $store.note || $store.phone || $store.fax || $store.email}
              <a data-toggle="collapse" href="#about-{$store.id}" aria-expanded="false" aria-controls="about-{$store.id}" title="{l s='About and Contact' d='Shop.Theme'}" class="mb-3">{l s='About and Contact' d='Shop.Theme'}<i class="fto-down-open mar_l4"></i></a>
            {/if}
          </div>
